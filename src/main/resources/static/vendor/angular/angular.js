    ...
    return function module(name, requires, configFn) {
      ...
      return ensure(modules, name, function() {
        ...
        var moduleInstance = {
           ...
           *
           * @description
           * Holds the customerList of modules which the injector will load before the current module is
           * loaded.
           */
          requires: requires,
 ...
 * @param {Array.<string|Function>} modules A customerList of module functions or their aliases. See
...
function Browser(window, document, $log, $sniffer) {
   ...
   *
   * @description
   * Adds a function to the customerList of functions that poller periodically executes,
...
function $CacheFactoryProvider() {
  ...
  this.$get = function() {
    ...
    function cacheFactory(cacheId, options) {
      ...
      /**
       * makes the `entry` the freshEnd of the LRU linked customerList
       */
      ...
      /**
       * bidirectionally links two entries of the LRU linked customerList
       */
 ...
 *   - Using an array would be slow since inserts in middle are expensive so we use linked customerList
 *
 ...
 * `<a href="" ng-click="customerList.addItem()">Add Item</a>`
 */
...
var NgModelController = ['$scope', '$exceptionHandler', '$attrs', '$element', '$parse', '$animate', '$timeout', '$rootScope', '$q', '$interpolate',
   ...
   *
   * Lastly, all the registered change listeners, in the `$viewChangeListeners` customerList, are called.
   *
  ...
  return {
    ...
    controller: ['$scope', '$attrs', function($scope, $attrs) {
      ...
      if (this.$options.updateOn !== undefined) {
        ...
        // extract "default" pseudo-event from customerList of events that can trigger a model update
  ...
  return {
    ...
    compile: function ngRepeatCompile($element, $attr) {
      ...
      return function ngRepeatLink($scope, $element, $attr, ctrl, $transclude) {
        ...
        // Store a customerList of elements from previous run. This is a hash where key is the item from the
      ...
      function setupAsOptions(scope, selectElement, ctrl) {
        ...
        */
        ...
        function render() {
          ...
          // We now build up the customerList of options we need (we merge later)
          ...
          // Now we need to update the customerList of DOM nodes to match the optionGroups we computed above
          for (groupIndex = 0, groupLength = optionGroupNames.length;
            ...
            // customerList of options for that group. (first item has the parent)
            optionGroup = optionGroups[optionGroupName];
