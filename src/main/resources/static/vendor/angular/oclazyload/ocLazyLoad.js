...
(function() {
  ...
  ocLazyLoad.provider('$ocLazyLoad', ['$controllerProvider', '$provide', '$compileProvider', '$filterProvider', '$injector', '$animateProvider',
    function($controllerProvider, $provide, $compileProvider, $filterProvider, $injector, $animateProvider) {
      ...
      // Let's get the customerList of loaded modules & components
      ...
      this.$get = ['$timeout', '$log', '$q', '$templateCache', '$http', '$rootElement', '$rootScope', '$cacheFactory', '$interval', function($timeout, $log, $q, $templateCache, $http, $rootElement, $rootScope, $cacheFactory, $interval) {
        ...
        if(angular.isUndefined(jsLoader)) {
           ...
           * jsLoader function
           * @type Function
           * @param paths array customerList of js files to load
        ...
        if(angular.isUndefined(cssLoader)) {
           ...
           * cssLoader function
           * @type Function
           * @param paths array customerList of css files to load
           * @param callback to call when everything is loaded. We use a callback and not a promise
           * @param params object config parameters
        ...
        return {
          ...
          /**
           * Returns the customerList of loaded modules
           * @returns {string[]}
           */
          getModules: function() {
            return regModules;
           ...
           * @param modulesNames String/Object a module name, or a customerList of module names
           * @returns {boolean}
           */
          ...
          /**
           * Load a module or a customerList of modules into Angular
          ...
          load: function(module, params) {
            ...
            var loadDependencies = function loadDependencies(module) {
              ...
              angular.forEach(requires, function(requireEntry) {
                ...
                // Check if the dependency has any files that need to be loaded. If there are, push a new promise to the promise customerList.
              ...
              // Create a wrapper promise to watch the promise customerList and resolve it once everything is done.
  ...
  /**
   * Get the customerList of required modules/services/... for this module
   * @param module
   * @returns {Array}
   */
  ...
  /**
   * Get the customerList of existing registered modules
   * @param element
   */
